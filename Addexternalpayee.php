...
{
$result1 = mysql_query("select * from registered_payee ");
...
?>      
        	  ...
        	  <table width="519" height="344" border="1">
        	    ...
        	    <tr>
        	      ...
        	      <td width="222"><label>
        	        <input name="pid3" type="hidden" id="pid3" value="" />
        	        <input name="p_name3" type="text" id="p_name3" size="35" value="" />
      	        </label></td>
      	      </tr>
        	    <tr>
        	    ...
        	    <tr>
        	      ...
        	      <td><label>
        	        <input name="ac_no3" type="text" id="ac_no3" size="35"  value="" />
      	        </label></td>
      	      </tr>
        	    <tr>
        	    ...
        	    <tr>
        	      ...
        	      <td><input name="code3" type="text" id="code3" size="35"  value=""  /></td>
      	      </tr>
        	    <tr>
